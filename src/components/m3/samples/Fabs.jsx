...
const FloatingActionButtons = () => {
  return (
    <Box>
      ...
      <Typography variant="h6">M3 FAB</Typography>
      <BoxComponent>
        <Fab variant="primary" title="Primary">
          <FabIcon />
        </Fab>
        <Fab variant="surface" title="Surface">
          <FabIcon />
        </Fab>
        <Fab variant="secondary" title="Secondary">
          <FabIcon />
        </Fab>
        <Fab variant="tertiary" title="Tertiary">
          <FabIcon />
        </Fab>
      ...
      <Typography variant="h6">M3 FAB Extended</Typography>
      <BoxComponent>
