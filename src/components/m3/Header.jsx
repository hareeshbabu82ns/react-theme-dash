...
import { ThemeModeContext, ThemeSchemeContext } from "themes/m3";
...
const Header = ({ onDrawerToggle, window }) => {
  ...
  const changeThemeScheme = async () => {
    ...
    const randaomColors = tinycolor
      ...
      .tetrad()
      .map((c) => c.toHexString());
    generateThemeScheme(randaomColors[0], {
          ...
          <Grid container spacing={1} alignItems="center">
            ...
            <Grid item sx={{ display: "flex", alignItems: "baseline" }}>
              ...
              <Fade in={trigger}>
                <Typography
                  color="inherit"
                  sx={{ ml: 1, fontSize: 16, fontWeight: 500 }}
                >
                  <ArrowIcon sx={{ fontSize: 12 }} color="inherit" />{" "}
